...
## IIFE (Immediately Invoked Function Expression) is an anonumous function that instantly calls itself
...
## Spread Operator:
used to combine arrays, it expands the contents of an array into individual elements

## Rest Operator:
used as a way to pass in multiple arguments, or in other words, the implementation of var args
